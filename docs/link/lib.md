...
|     |**Fabric**| 用于构建与 Office 和 Office 365 界面相类似的 Web 应用的 React 组件，Fabric 是用 TypeScript 编写的官方 Office 库，包含“入门”指南、博客、官方调色板和字体，以及构建项目所需的所有组件 <br> 官网：<https://developer.microsoft.com/en-us/fabric#/components> <br> Github：<https://github.com/OfficeDev/office-ui-fabric-react> ![Github stars](https://img.shields.io/github/stars/OfficeDev/office-ui-fabric-react.svg)|
|     |**element-react**| [Element](https://github.com/ElemeFE/element) 官方介绍，一眼就懂 <br> 官方教程：<https://elemefe.github.io/element-react/#/zh-CN/quick-start> <br> Github：<https://github.com/ElemeFE/element-react> ![Github stars](https://img.shields.io/github/stars/ElemeFE/element-react.svg)|
|vue|**element**| Element，一套为开发者、设计师和产品经理准备的基于 Vue 2.0 的桌面端组件库 <br> 官方教程： <http://element-cn.eleme.io/#/zh-CN/component/installation> <br> Github：  <https://github.com/ElemeFE/element> ![Github stars](https://img.shields.io/github/stars/ElemeFE/element.svg)|
|   |**iview**| 一套基于 Vue.js 的高质量 UI 组件库 <br> 官方教程：<https://www.iviewui.com/docs/guide/install> <br> Github：<https://github.com/iview/iview> ![Github stars](https://img.shields.io/github/stars/iview/iview.svg)|
|   |**Ant Design Vue**|ant-design-vue 为 Web 应用提供了丰富的基础 UI 组件，我们还将持续探索企业级应用的最佳 UI 实践 <br> 官方文档：https://www.antdv.com/components/overview-cn/ <br>  Github：<https://github.com/vueComponent/ant-design-vue> ![Github stars](https://img.shields.io/github/stars/vueComponent/ant-design-vue.svg)|
|   |**Keen-UI**|A lightweight Vue.js UI library with a simple API, inspired by Google's Material Design. <br> 官方文档：https://josephuspaye.github.io/Keen-UI/#/ui-alert <br>  Github：<https://github.com/JosephusPaye/Keen-UI> ![Github stars](https://img.shields.io/github/stars/JosephusPaye/Keen-UI.svg)|
|通用|**bootstrap**| 简洁、直观、强悍的前端开发框架，让web开发更迅速、简单 <br> 官网：<http://www.bootcss.com/> <br> Github：<https://github.com/twbs/bootstrap> ![Github stars](https://img.shields.io/github/stars/twbs/bootstrap.svg)|
|    |**wired-elements**| 手绘风格的一套很特别的组件 <br> 官网：[wiredjs.com](http://wiredjs.com/) <br> Github：<https://github.com/wiredjs/wired-elements> ![Github stars](https://img.shields.io/github/stars/wiredjs/wired-elements.svg)|

# js三方库

|<div style="width:100px;">类别</div>|<div style="width:150px;">名称</div>|**Github**|**说明**|
|-|-|-|-|
